...
If every entry in the condition ECT `authority` can be successfully byte-compared to a matching entry in the ACS entry `authority` field, then the authorities match.
