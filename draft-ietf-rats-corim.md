...
If the key is certified (i.e., a certificate is issued for the key by a certificate authority), the certification path is validated according to {{Section 6 of -pkix-cert}}.
