...
The digest value can be used to locate a public key contained in a lookup table, for example. Ultimately, the discovered keys have to be able to be successfully byte-compared with the corresponding keys.
