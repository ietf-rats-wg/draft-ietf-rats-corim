...
A CoRIM Identifier uniquely identifies a CoRIM instance within the context of a CoRIM issuer.  In other words the CoRIM identifier is not globally unique,
but can be used to distinguish CoRIMs that come from the same issuer.
