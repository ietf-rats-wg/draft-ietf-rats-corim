...
COMID_FRAGS += trust-dependency-triple-record.cddl
...
COMID_FRAGS += tagged-masked-raw-value.cddl
...
CORIM_FRAGS += cose-sign-corim.cddl
...
CORIM_FRAGS += signature-structure.cddl
...
INTREP_FRAGS += intrep-m-ect.cddl
INTREP_FRAGS += intrep-k-ect.cddl
INTREP_FRAGS += intrep-t-ect.cddl
...
INTREP_FRAGS += intrep-trust-dep.cddl
...
INTREP_FRAGS += intrep-ect-trust-dep-addition.cddl
INTREP_FRAGS += intrep-ect-trust-dep-condition.cddl
INTREP_FRAGS += intrep-trust-dep-item.cddl
...
INTREP_FRAGS += int-range-type-choice.cddl
